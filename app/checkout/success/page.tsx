          ...
          <CardContent className="space-y-6">
            ...
            <div className="text-center text-sm text-gray-600 space-y-1">
              <p>
                ...
                <a href="mailto:support@jinsunmachineries.com" className="text-blue-600 hover:underline">
                  support@jinsunmachineries.com
                </a>{" "}
                or{" "}
                <a href="mailto:Jinsunwentoumachineries.hk@gmail.com" className="text-blue-600 hover:underline break-all">
