...
import { Mail, MapPin, Clock, Facebook, Twitter, Linkedin, Instagram } from "lucide-react"
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-slate-300 text-sm space-y-1">
                  <p>support@jinsunmachineries.com</p>
                  <p className="break-all">Jinsunwentoumachineries.hk@gmail.com</p>
                </div>
              </div>
